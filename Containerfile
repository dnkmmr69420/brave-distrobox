...
RUN      dnf config-manager addrepo https://brave-browser-rpm-release.s3.brave.com/brave-browser.repo
RUN      rpm --import https://brave-browser-rpm-release.s3.brave.com/brave-core.asc
RUN      dnf install -y brave-browser

RUN      dnf config-manager addrepo https://brave-browser-rpm-beta.s3.brave.com/brave-browser-beta.repo
RUN      rpm --import https://brave-browser-rpm-beta.s3.brave.com/brave-core-nightly.asc
RUN      dnf install -y brave-browser-beta

RUN      dnf config-manager addrepo https://brave-browser-rpm-nightly.s3.brave.com/brave-browser-nightly.repo
